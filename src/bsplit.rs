...
fn binary_split_2_arb(
    ...
    unsafe {
        if b - a == 1 {
            ...
            // Q(a, a + 1) = a^3 * 640320^3 / 24
            let mut q = util::new_arb_with_u64(a * a); // Safe for digits < 2e+20
            flint3_sys::arb_mul(&mut q[0], &q[0], &q_partial.0[0], prec);
            flint3_sys::arb_mul_ui(&mut q[0], &q[0], a, prec);
            ...
            // flint3_sys::fmpz_fmma(&mut r2[0], &q2[0], &r1[0], &p1[0],
            // &r2[0]);
...
pub fn binary_split_arb(
    ...
    unsafe {
        let mut q_partial = SharedArb(util::new_arb_with_u64(640320));
        flint3_sys::arb_mul_ui(
            &mut q_partial.0[0],
            &q_partial.0[0],
            640320,
            prec,
        ...
        flint3_sys::arb_clear(&mut q_partial.0[0]);
